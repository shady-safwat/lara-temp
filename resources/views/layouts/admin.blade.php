...
<div class="fixed-plugin">
        ...
        <ul class="dropdown-menu">
            ...
            <a class="img-holder switch-trigger" href="javascript:void(0)">
                <img src="adminpanel/assets/img/sidebar-1.jpg" alt="">
            </a>
            </li>
            <li class="active">
            <a class="img-holder switch-trigger" href="javascript:void(0)">
                <img src="adminpanel/assets/img/sidebar-2.jpg" alt="">
            </a>
            </li>
            <li>
            <a class="img-holder switch-trigger" href="javascript:void(0)">
                <img src="adminpanel/assets/img/sidebar-3.jpg" alt="">
            </a>
            </li>
            <li>
            <a class="img-holder switch-trigger" href="javascript:void(0)">
                <img src="adminpanel/assets/img/sidebar-4.jpg" alt="">
            </a>
            </li>
    ...
    <script src="adminpanel/assets/js/material-dashboard.js?v=2.1.0"></script>
